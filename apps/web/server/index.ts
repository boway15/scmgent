...
import { inventoryPlanningRoutes } from './routes/inventory-planning.js';
import { planningDashboardRoutes } from './routes/planning-dashboard.js';
...
import { productCostingRoutes } from './routes/product-costing.js';
...
import { layeredForecastRoutes } from './routes/layered-forecast.js';
...
app.route('/api', inventoryPlanningRoutes);
app.route('/api', planningDashboardRoutes);
...
app.route('/api', productCostingRoutes);
...
app.route('/api', salesAnalyticsRoutes);
...
app.route('/api', layeredForecastRoutes);
