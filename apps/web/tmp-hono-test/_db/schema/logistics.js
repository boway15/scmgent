import { pgTable, pgEnum, uuid, varchar, text, integer, numeric, timestamp, boolean, index, uniqueIndex, } from 'drizzle-orm/pg-core';
...
export const fobServiceProviders = pgTable('fob_service_providers', {
    ...
    typeActiveIdx: index('fob_service_providers_type_active_idx').on(table.providerType, table.isActive),
}));
export const fobSettlementBatches = pgTable('fob_settlement_batches', {
    id: uuid('id').primaryKey().defaultRandom(),
...
export const fobFeeAllocationRules = pgTable('fob_fee_allocation_rules', {
    id: uuid('id').primaryKey().defaultRandom(),
    ...
    billTypeIdx: index('fob_fee_allocation_rules_bill_type_idx').on(table.sourceBillType, table.isActive),
}));
export const fobMerchantShipments = pgTable('fob_merchant_shipments', {
    id: uuid('id').primaryKey().defaultRandom(),
    ...
    batchContainerIdx: index('fob_merchant_shipments_batch_container_idx').on(table.batchId, table.containerNo),
}));
export const fobContainerMerchantStats = pgTable('fob_container_merchant_stats', {
    id: uuid('id').primaryKey().defaultRandom(),
    batchId: uuid('batch_id')
        .notNull()
        .references(() => fobSettlementBatches.id, { onDelete: 'cascade' }),
    ...
    batchContainerMerchantUq: uniqueIndex('fob_container_merchant_stats_uq').on(table.batchId, table.containerNo, table.merchantCode),
}));
...
export const fobTruckingBillItems = pgTable('fob_trucking_bill_items', {
    id: uuid('id').primaryKey().defaultRandom(),
    batchId: uuid('batch_id')
        .notNull()
        .references(() => fobSettlementBatches.id, { onDelete: 'cascade' }),
    ...
    batchContainerIdx: index('fob_trucking_bill_items_batch_container_idx').on(table.batchId, table.containerNo),
}));
export const fobFreightBillItems = pgTable('fob_freight_bill_items', {
    id: uuid('id').primaryKey().defaultRandom(),
    batchId: uuid('batch_id')
        .notNull()
        .references(() => fobSettlementBatches.id, { onDelete: 'cascade' }),
    ...
    batchContainerIdx: index('fob_freight_bill_items_batch_container_idx').on(table.batchId, table.containerNo),
}));
export const fobSettlementAllocations = pgTable('fob_settlement_allocations', {
    id: uuid('id').primaryKey().defaultRandom(),
    batchId: uuid('batch_id')
        .notNull()
        .references(() => fobSettlementBatches.id, { onDelete: 'cascade' }),
    ...
    batchMerchantIdx: index('fob_settlement_allocations_batch_merchant_idx').on(table.batchId, table.merchantCode),
}));
export const fobSettlementAdjustments = pgTable('fob_settlement_adjustments', {
    id: uuid('id').primaryKey().defaultRandom(),
    batchId: uuid('batch_id')
        .notNull()
        .references(() => fobSettlementBatches.id, { onDelete: 'cascade' }),
...
export const fobMerchantPaymentStatus = pgTable('fob_merchant_payment_status', {
    id: uuid('id').primaryKey().defaultRandom(),
    batchId: uuid('batch_id')
        .notNull()
        .references(() => fobSettlementBatches.id, { onDelete: 'cascade' }),
    ...
    batchMerchantUq: uniqueIndex('fob_merchant_payment_status_batch_merchant_uq').on(table.batchId, table.merchantCode),
}));
