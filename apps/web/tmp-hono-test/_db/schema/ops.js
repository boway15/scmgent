import { pgTable, pgEnum, uuid, varchar, text, integer, date, timestamp, index, uniqueIndex, } from 'drizzle-orm/pg-core';
import { relations } from 'drizzle-orm';
import { users } from './auth.js';
import { skus, inventoryRecords } from './inventory.js';
import { pmcPlans, pmcPlanItems } from './pmc.js';
...
export const pmcReceipts = pgTable('pmc_receipts', {
    id: uuid('id').primaryKey().defaultRandom(),
    planId: uuid('plan_id')
        .notNull()
