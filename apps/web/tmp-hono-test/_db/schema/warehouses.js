import { pgTable, uuid, varchar, boolean, integer, numeric, timestamp, uniqueIndex, } from 'drizzle-orm/pg-core';
...
export const channelWarehousePrefs = pgTable('channel_warehouse_prefs', {
    id: uuid('id').primaryKey().defaultRandom(),
