...
const MIGRATION_FILES = [
  ...
  '0017_email_auth.sql',
  '0018_audit_logs.sql',
  '0019_supply_chain_replenishment.sql',
  '0020_sales_forecast_monthly.sql',
  '0021_sku_encoding.sql',
  '0022_inventory_health_lights.sql',
  '0023_inventory_ops_production.sql',
  '0024_sales_forecast_platform.sql',
  '0025_sales_forecast_management.sql',
  '0026_widen_spu_numeric_code.sql',
  '0027_widen_variant_no.sql',
  '0028_ai_runs.sql',
  '0029_purchase_tracking_lifecycle.sql',
  '0030_sales_forecast_collaboration.sql',
  '0031_sales_history_monthly.sql',
  '0032_sku_inventory_master_fields.sql',
  '0033_turnover_bucket_warehouses.sql',
  '0034_sales_history_category.sql',
  '0035_news_intel.sql',
  '0036_news_article_bitable_category.sql',
  '0037_sales_history_import_perf.sql',
  '0038_forecast_horizon_factors.sql',
  '0039_forecast_eligibility.sql',
  '0040_forecast_profile_horizon.sql',
  '0041_forecast_exogenous_flags.sql',
  '0042_cs_reply_quality.sql',
  '0043_cs_reply_menu_rename.sql',
  '0044_procurement_module.sql',
  '0045_news_intel_v2.sql',
  '0046_news_intel_menu.sql',
];
