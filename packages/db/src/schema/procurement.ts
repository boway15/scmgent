...
export const purchaseDrafts = pgTable(
  'purchase_drafts',
  {
    ...
    plannedProductionDoneDate: date('planned_production_done_date'),
    actualProductionDoneDate: date('actual_production_done_date'),
    plannedPickupDate: date('planned_pickup_date'),
    etd: date('etd'),
    etaPort: date('eta_port'),
    customsDoneDate: date('customs_done_date'),
    etaWarehouse: date('eta_warehouse'),
