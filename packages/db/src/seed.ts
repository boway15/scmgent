...
const MENU_SEEDS: MenuSeed[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { code: 'inventory.planning_dashboard', name: '规划驾驶舱', path: '/inventory/planning-dashboard', sortOrder: 6, isLeaf: true },
    ],
  },
  {
    code: 'pmc',
  ...
  },
  {
    ...
    children: [
      ...
      { code: 'data.layered_forecast', name: '分层销量预测', path: '/data/layered-forecast', sortOrder: 5, isLeaf: true },
    ],
  },
  {
    code: 'intel',
  ...
  },
  {
    ...
    children: [
      ...
      { code: 'system.tasks', name: '定时任务', path: '/system/tasks', sortOrder: 4, isLeaf: true },
    ],
  },
];
...
const ROLE_MENU_CODES: Record<string, string[]> = {
  super_admin: ['dashboard', 'inventory', 'inventory.overview', 'inventory.safety', 'inventory.alert', 'inventory.planning', 'inventory.lead_time', 'inventory.planning_dashboard', 'pmc', 'pmc.suggestion', 'pmc.list', 'pmc.tracking', 'pmc.shipments', 'procurement', 'procurement.bulk_stock', 'procurement.follow_up', 'procurement.costing', 'cs', 'cs.quality', 'logistics', 'logistics.fob_settlement', 'data', 'data.products', 'data.sales', 'data.forecast', 'data.sales_analytics', 'data.layered_forecast', 'intel', 'intel.news', 'ai', 'ai.chat', 'help', 'system', 'system.users', 'system.roles', 'system.logs', 'system.tasks'],
  pmc_planner: ['dashboard', 'inventory', 'inventory.overview', 'inventory.safety', 'inventory.lead_time', 'inventory.planning', 'inventory.planning_dashboard', 'pmc', 'pmc.suggestion', 'pmc.list', 'pmc.shipments', 'procurement', 'procurement.bulk_stock', 'logistics', 'logistics.fob_settlement', 'cs', 'cs.quality', 'data', 'data.products', 'data.sales', 'data.forecast', 'data.sales_analytics', 'data.layered_forecast', 'ai', 'ai.chat', 'help'],
  warehouse: ['dashboard', 'inventory', 'inventory.overview', 'inventory.alert', 'pmc', 'pmc.list', 'logistics', 'logistics.fob_settlement', 'cs', 'cs.quality', 'data', 'data.products', 'data.sales', 'data.forecast', 'data.sales_analytics', 'data.layered_forecast', 'ai', 'ai.chat', 'help'],
  purchaser: ['dashboard', 'inventory', 'inventory.overview', 'inventory.safety', 'inventory.alert', 'inventory.lead_time', 'inventory.planning', 'inventory.planning_dashboard', 'pmc', 'pmc.list', 'pmc.tracking', 'pmc.shipments', 'procurement', 'procurement.bulk_stock', 'procurement.follow_up', 'procurement.costing', 'logistics', 'logistics.fob_settlement', 'cs', 'cs.quality', 'data', 'data.products', 'data.sales', 'data.forecast', 'data.sales_analytics', 'data.layered_forecast', 'ai', 'ai.chat', 'help'],
  viewer: ['dashboard', 'inventory', 'inventory.overview', 'pmc', 'pmc.suggestion', 'pmc.list', 'pmc.tracking', 'procurement', 'procurement.bulk_stock', 'procurement.follow_up', 'procurement.costing', 'logistics', 'logistics.fob_settlement', 'cs', 'cs.quality', 'data', 'data.sales', 'data.forecast', 'data.sales_analytics', 'data.layered_forecast', 'ai', 'ai.chat', 'help'],
};
...
async function main() {
  ...
  console.log('Seeding FOB service providers...');
  await seedFobServiceProviders();
